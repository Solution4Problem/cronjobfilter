...
def greet_user(ip_user_name):
    """
    This function will greet the user by printing the line.
    parameters:
        ip_user_name (string) : person's name
    return:
        None
    """
    print(f"Hello my friend {ip_user_name} ! How are you ?")

if __name__ == "__main__":
    greet_user("Priyesh Naik")
